...
// enum INSTRUCTION_TYPE とするとワーニングが出るので
// simd_instruction_type.h のenumにtypedefを付けることにした
// static int set_simd_multi2(void *m2, enum INSTRUCTION_TYPE);
static int set_simd_multi2(void* m2, INSTRUCTION_TYPE);
...
static int set_simd_multi2(void *m2, INSTRUCTION_TYPE instruction)
{
...
#else	/* ENABLE_MULTI2_SIMD
	// int 型の関数なのでとりあえず0を返すように追加 */
	return 0;
#endif
}
